...
<!-- custom body -->
    ...
    <section id="content-body-well">
        ...
        <!-- content well -->
            ...
            <!-- intro paragraph -->
            <p>Bacon ipsum dolor amet ham hock ribeye mollit andouille lorem duis. Sed cillum drumstick consequat biltong laboris. Nostrud et voluptate enim ut, anim qui aliquip est cupim kielbasa aliqua. Culpa occaecat fatback, cow reprehenderit sirloin pork chop pastrami ea elit incididunt sunt andouille.</p>
            <!-- /end intro paragraph -->
            ...
            <!-- <iframe id="datawrapper-chart-YANGD" class="hc-graphic" src="//datawrapper.dwcdn.net/YANGD/5/" frameborder="0" allowtransparency="true" allowfullscreen="allowfullscreen" webkitallowfullscreen="webkitallowfullscreen" mozallowfullscreen="mozallowfullscreen" oallowfullscreen="oallowfullscreen" msallowfullscreen="msallowfullscreen" width="100%" height="610"></iframe><script type="text/javascript">if("undefined"==typeof window.datawrapper)window.datawrapper={};window.datawrapper["YANGD"]={},window.datawrapper["YANGD"].embedDeltas={"100":610,"200":610,"300":610,"400":610,"500":610,"600":610,"700":610,"800":610,"900":610,"1000":610},window.datawrapper["YANGD"].iframe=document.getElementById("datawrapper-chart-YANGD"),window.datawrapper["YANGD"].iframe.style.height=window.datawrapper["YANGD"].embedDeltas[Math.min(1e3,Math.max(100*Math.floor(window.datawrapper["YANGD"].iframe.offsetWidth/100),100))]+"px",window.addEventListener("message",function(a){if("undefined"!=typeof a.data["datawrapper-height"])for(var b in a.data["datawrapper-height"])if("YANGD"==b)window.datawrapper["YANGD"].iframe.style.height=a.data["datawrapper-height"][b]+"px"});</script>

            <iframe id="datawrapper-chart-eMBsc" class="hc-graphic" src="//datawrapper.dwcdn.net/eMBsc/2/" frameborder="0" allowtransparency="true" allowfullscreen="allowfullscreen" webkitallowfullscreen="webkitallowfullscreen" mozallowfullscreen="mozallowfullscreen" oallowfullscreen="oallowfullscreen" msallowfullscreen="msallowfullscreen" width="100%" height="610"></iframe><script type="text/javascript">if("undefined"==typeof window.datawrapper)window.datawrapper={};window.datawrapper["eMBsc"]={},window.datawrapper["eMBsc"].embedDeltas={"100":637,"200":610,"300":610,"400":610,"500":610,"600":610,"700":610,"800":610,"900":610,"1000":610},window.datawrapper["eMBsc"].iframe=document.getElementById("datawrapper-chart-eMBsc"),window.datawrapper["eMBsc"].iframe.style.height=window.datawrapper["eMBsc"].embedDeltas[Math.min(1e3,Math.max(100*Math.floor(window.datawrapper["eMBsc"].iframe.offsetWidth/100),100))]+"px",window.addEventListener("message",function(a){if("undefined"!=typeof a.data["datawrapper-height"])for(var b in a.data["datawrapper-height"])if("eMBsc"==b)window.datawrapper["eMBsc"].iframe.style.height=a.data["datawrapper-height"][b]+"px"});</script>

            <iframe id="datawrapper-chart-XBeSv" class="hc-graphic" src="//datawrapper.dwcdn.net/XBeSv/1/" frameborder="0" allowtransparency="true" allowfullscreen="allowfullscreen" webkitallowfullscreen="webkitallowfullscreen" mozallowfullscreen="mozallowfullscreen" oallowfullscreen="oallowfullscreen" msallowfullscreen="msallowfullscreen" width="100%" height="764"></iframe><script type="text/javascript">if("undefined"==typeof window.datawrapper)window.datawrapper={};window.datawrapper["XBeSv"]={},window.datawrapper["XBeSv"].embedDeltas={"100":791,"200":764,"300":764,"400":764,"500":764,"600":764,"700":764,"800":764,"900":764,"1000":764},window.datawrapper["XBeSv"].iframe=document.getElementById("datawrapper-chart-XBeSv"),window.datawrapper["XBeSv"].iframe.style.height=window.datawrapper["XBeSv"].embedDeltas[Math.min(1e3,Math.max(100*Math.floor(window.datawrapper["XBeSv"].iframe.offsetWidth/100),100))]+"px",window.addEventListener("message",function(a){if("undefined"!=typeof a.data["datawrapper-height"])for(var b in a.data["datawrapper-height"])if("XBeSv"==b)window.datawrapper["XBeSv"].iframe.style.height=a.data["datawrapper-height"][b]+"px"});</script> -->
            ...
            <div class="hc-credits">
                <div><strong>Video/Motion: </strong><a href="">Ali Rizvi</a> and <a href="https://twitter.com/sohailal_jamea">Sohail Al-Jamea</a></div>
                <div><strong>Narration: </strong><a href="https://twitter.com/davincoburn">Davin Coburn</a></div>
                <div><strong>Reporting: </strong><a href="https://twitter.com/GregHadley9">Greg Hadley</a> and <a href="https://twitter.com/elizabethrkoh">Elizabeth Koh</a></div>
                <div><strong>Editing: </strong><a href="https://twitter.com/jforsythe23">Jon Forsythe</a> and <a href="https://twitter.com/juliemmoos">Julie Moos</a></div>
                <!-- <div><strong>Copy editor: </strong>Firstname Lastname</div> -->
                <div><strong>Illustrations: </strong><a href="https://twitter.com/JACKOHMAN">Jack Ohman</a></div>
                <div><strong>Graphics: </strong><a href="https://twitter.com/GregHadley9">Greg Hadley</a></div>
                <div><strong>Design: </strong><a href="https://twitter.com/kristi_walker">Kristi Walker</a></div>
            </div>
            <!-- /end credits -->
