    ...
    <section id="content-body-well">
        ...
        <nav id="hc-nav">
            <div id="hc-nav-margin">
                <div id="hc-nav-logo">McClatchy</div>
